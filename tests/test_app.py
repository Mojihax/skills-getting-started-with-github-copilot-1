...
def test_signup_and_unregister():
    ...
    # Unregister
    url = f"/activities/{urllib.parse.quote(activity)}/unregister?email={urllib.parse.quote(email)}"
...
def test_duplicate_signup():
    ...
    # Cleanup
    client.delete(f"/activities/{urllib.parse.quote(activity)}/unregister?email={urllib.parse.quote(email)}")
from fastapi.testclient import TestClient
import pytest
